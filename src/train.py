...
def make_env(level_name, port):
    ...
    """
    def _init():
        env = PlantEdEnv(f"Level3_try1_{level_name}", port, level_name)
        env.reset()
        return env
    return _init
...
if __name__ == "__main__":
  ...
  model.learn(30*600*6, log_interval=10)
  envs.close()

  print(model)
  model.save("models/Level3_try1")
  envs.save("models/Level3_try1_vec_normalize.pkl")
